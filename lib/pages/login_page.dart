...
import 'package:dzh_app/model/login_rsp_entity.dart';
import 'package:dzh_app/pages/main_page.dart';
      ...
      child: new RaisedButton(
        ...
        onPressed: ()async{
          ...
          if ((_formKey.currentState as FormState).validate()) {
            ...
            var resp = await HttpUtil.getInstance().post('m/sysuser/login',data: {"inputStr":"$_username","password":"$_password","clientType":"app"},);
            LoginRspEntity entity = LoginRspEntity.fromJson(json.decode(resp));
            SpUtils.setUser(entity.userInfo);
